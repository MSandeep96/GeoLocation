...
import {signIn} from '../../../actions/UserCalls'
...
class SignIn extends Component {
  ...
  render() {
    ...
    let btnDisabled = !(emailClass === 'correct' && passClass === 'correct');
    return (
      <form className="email-signin" onSubmit={this.handleSubmit}>
        ...
        <div className="u-form-group">
          <button disabled={btnDisabled}>Sign In</button>
